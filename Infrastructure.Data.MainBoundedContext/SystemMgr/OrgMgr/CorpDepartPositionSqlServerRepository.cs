...
{
    public class CorpDepartPositionSqlServerRepository : Repository<CorpDepartPosition>, ICorpDepartPositionRepository
    {
        public CorpDepartPositionSqlServerRepository(MainUnitOfWork unitWork) : base(unitWork)
        {
